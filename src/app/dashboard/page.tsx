  ...
  return (
    <>
      <section className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div
          className={`relative z-10 flex flex-col justify-center h-full px-6 md:px-24 max-w-4xl text-white transition-all duration-1000 mt-10 ${
            mostrar ? " translate-x-0" : " translate-x-full"
          }`}
        >
          <h1
            className={`text-4xl md:text-5xl font-bold uppercase leading-tight transition-all duration-1000 `}
          >
            ingcontel
          </h1>
          <h2 className="text-4xl md:text-2xl font-bold uppercase leading-tight">
            ¡Conectamos Colombia con Innovación!
          </h2>
          <p className="text-lg md:text-xl font-light mt-4 lowercase">
